class GameScene extends Phaser.Scene {
  ...
  update() {
    // check if player is created before updating
  ...
  spawnMonster(monsterObject) {
    ...
    if (!monster) {
      monster = new Monster(  
        this,
        monsterObject.x, // remove scaling // NEW
        monsterObject.y, // remove scaling // NEW
        'monsters',
        monsterObject.frame,
        monsterObject.id,
      ...
      monster.setPosition(monsterObject.x, monsterObject.y); // pass unscaled arguments // NEW
      monster.makeActive();
    }
  }
